...
public partial class ShopGiayContext : DbContext
{
    ...
    public virtual DbSet<TLoaiSd> TLoaiSds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=ShopGiay;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TDanhMucSp>(entity =>
        {
            ...
            entity.HasOne(d => d.MaSdNavigation).WithMany(p => p.TDanhMucSps)
                .HasForeignKey(d => d.MaSd)
                .HasConstraintName("FK_tDanhMucSP_tLoaiSD");
        });
        ...
        modelBuilder.Entity<TLoaiSd>(entity =>
        {
            entity.HasKey(e => e.MaSd);

            entity.ToTable("tLoaiSD");
